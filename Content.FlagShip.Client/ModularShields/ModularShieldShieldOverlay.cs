...
public sealed class ModularShieldShieldOverlay : Overlay
{
    ...
    public ModularShieldShieldOverlay(IEntityManager entityManager, IPrototypeManager prototypeManager, IResourceCache resourceCache)
    {
        ...
        _shieldTexture = _resourceCache.GetTexture("/Textures/_Flagship/Structures/Machines/modularshieldprojectedshield.png");

        _unshadedShader = prototypeManager.Index<ShaderPrototype>(UnshadedShader).Instance();
    ...
    protected override void Draw(in OverlayDrawArgs args)
    {
        ...
        var enumerator = _entManager.AllEntityQueryEnumerator<ModularShieldShieldVisualsComponent, FixturesComponent, TransformComponent>();

...
public sealed partial class FireControlSystem : EntitySystem
{
    ...
    {
        SubscribeLocalEvent<FlagShip.Shared.FireControl.FireControlConsoleComponent, PowerChangedEvent>(OnPowerChanged);
        SubscribeLocalEvent<FlagShip.Shared.FireControl.FireControlConsoleComponent, ComponentShutdown>(OnComponentShutdown);
        SubscribeLocalEvent<FlagShip.Shared.FireControl.FireControlConsoleComponent, FireControlConsoleRefreshServerMessage>(OnRefreshServer);
        SubscribeLocalEvent<FlagShip.Shared.FireControl.FireControlConsoleComponent, FireControlConsoleFireMessage>(OnFire);
        SubscribeLocalEvent<FlagShip.Shared.FireControl.FireControlConsoleComponent, BoundUIOpenedEvent>(OnUIOpened);
    }

    private void OnPowerChanged(EntityUid uid, FlagShip.Shared.FireControl.FireControlConsoleComponent component, PowerChangedEvent args)
    {
        if (args.Powered)
    ...
    private void OnComponentShutdown(EntityUid uid, FlagShip.Shared.FireControl.FireControlConsoleComponent component, ComponentShutdown args)
    {
        UnregisterConsole(uid, component);
    }

    private void OnRefreshServer(EntityUid uid, FlagShip.Shared.FireControl.FireControlConsoleComponent component, FireControlConsoleRefreshServerMessage args)
    {
    ...
    private void OnFire(EntityUid uid, FlagShip.Shared.FireControl.FireControlConsoleComponent component, FireControlConsoleFireMessage args)
    {
    ...
    public void OnUIOpened(EntityUid uid, FlagShip.Shared.FireControl.FireControlConsoleComponent component, BoundUIOpenedEvent args)
    {
        UpdateUi(uid, component);
    }

    private void UnregisterConsole(EntityUid console, FlagShip.Shared.FireControl.FireControlConsoleComponent? component = null)
    {
    ...
    private bool TryRegisterConsole(EntityUid console, FlagShip.Shared.FireControl.FireControlConsoleComponent? consoleComponent = null)
    {
    ...
    private void UpdateUi(EntityUid uid, FlagShip.Shared.FireControl.FireControlConsoleComponent? component = null)
    {

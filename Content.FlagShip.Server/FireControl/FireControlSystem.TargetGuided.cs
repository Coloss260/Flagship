...
public sealed partial class FireControlSystem
{
    ...
    private void InitializeTargetGuided()
    {
        ...
        SubscribeLocalEvent<FlagShip.Shared.FireControl.FireControlConsoleComponent, FireControlConsoleFireEvent>(OnConsoleFireEvent);
    }

    /// <summary>
    /// Track console fire events to update cursor positions
    /// </summary>
    private void OnConsoleFireEvent(EntityUid uid, FlagShip.Shared.FireControl.FireControlConsoleComponent component, FireControlConsoleFireEvent args)
    {
    ...
    private void OnTargetGuidedShot(EntityUid uid, GunComponent component, AmmoShotEvent args)
    {
            ...
            fireControllable.ControllingServer != null)
        {
            ...
            var query = EntityQueryEnumerator<FlagShip.Shared.FireControl.FireControlConsoleComponent>();
